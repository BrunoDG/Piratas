...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Criado por Angel Drive @ 2020. Todos os Direitos Reservados.\n" +
                "Angel Drive é: \n\nNathália Müller - História \nBruno Dias - Programação e sfx \nEris - Personagens\n\n" +
    ...
    use game_menu(_("Opções"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Lado de reversão")
                    textbutton _("Desligado") action Preference("rollback side", "disable")
...
#begin language_picker
                ...
                vbox:
                    ...
                    textbutton "Português (Brasil)" text_font "DejaVuSans.ttf" action Language(None)
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Passar o tempo automaticamente")
    ...
    use game_menu(_("Ajuda"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                if GamepadExists():
                    textbutton _("Joystick") action SetScreenVariable("device", "gamepad")
...
screen keyboard_help():
    ...
    hbox:
        label _("Espaço")
        text _("Avança diálogo sem escolher opções.")

    hbox:
        label _("Setas")
        text _("Nevegar pela interface.")
    ...
    hbox:
        label _("Tab")
        text _("Liga / desliga o pulo automático de diálogo.")

    hbox:
        label _("Page Up")
        text _("Pula para o diálogo anterior.")

    hbox:
        label _("Page Down")
        text _("Pula para o diálogo posterior.")
    ...
    hbox:
        label "S"
        text _("Tira uma foto da tela.")

    hbox:
        label "V"
        text _("Liga / Desliga a {a=https://www.renpy.org/l/voicing}voz de auxílio automática{/a}.")
...
screen mouse_help():
    ...
    hbox:
        ...
        text _("Avança diálogo e seleciona a interface.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Lateral direito")
        text _("Avança para o diálogo posterior.")


    hbox:
        label _("Direcinal e Analógico")
        text _("Navegam pela interface.")

    hbox:
        label _("Start, Guide")
        text _("Acessam o menu do jogo.")
